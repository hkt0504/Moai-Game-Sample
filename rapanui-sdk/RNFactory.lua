...
function RNFactory.init()
    ...
    if APP_CONFIG ~= nil and (APP_CONFIG == "mac" or APP_CONFIG == "linux" or APP_CONFIG == "windows" or APP_CONFIG == "steam") then
...
function RNFactory.createAnim(image, sizex, sizey, left, top, scaleX, scaleY, gutter, layer)
    ...
    local o = RNObject:new()
    local o, deck = o:initWithAnim2(image, sizex, sizey, scaleX, scaleY, gutter)
...
function RNFactory.createTextFrom(text, layer, params, putOnScreen)
    ...
    font = "arial-rounded.TTF"
    size = 15
    alignment = MOAITextLabel.CENTER_JUSTIFY
